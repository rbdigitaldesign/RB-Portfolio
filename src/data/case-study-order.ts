...
/**
 * Canonical display order for all case study pages.
 * Used by CaseStudyEdgeNav to compute prev/next navigation automatically.
 * Update this list when new case studies are added.
 */
export const CASE_STUDY_ORDER: CaseStudyMeta[] = [
  ...
  { slug: 'personal-professional-development-course-design', title: 'Personal Professional Development Course Design' },
